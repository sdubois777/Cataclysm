...
public:
	 ...
	 * actually moves on roughly 37% of its timers. `docs/Cataclysm_GDD_v2.md`
	 * section VIII states both numbers, because a reader given only one of them
	 ...
	 * It happens for real -- about one quest timer in five, before the coin is
	 * even reached.
	 *
