 ...
 * Issues #898, #1025 and #1733.
 *
 * WHAT THE LIST CLAIMS. Three stats deliberately have no gameplay attribute, and
 * bespoke code reads their increases directly instead. Three checks stop refusing
 ...
 * check #1025 lacked, and adding an unread fourth name is how this test is proved
 * to work.
 *
 ...
 *
 * HOW TO PROVE IT WORKS: add a fourth name to
		...
		if (!Probe)
		{
			AddError(FString::Printf(
				TEXT("'%s' is exempt from needing a gameplay attribute and no "
					 ...
					 "bespoke code reads the stat's increases; nothing checks "
					 "that promise but this. Add a probe that grants the stat "
					 "and asserts the reading code's answer changes, or take "
					 "the stat off "
					 "UCataclysmPlayerClassStats::StatsWithNoAttribute(). "
