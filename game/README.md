...
| `Content/Data/` | Eighteen DataTable assets: sixteen imported from the design workbook, and two from the simulation package's enemy model. See below. |
...
Two of the eighteen do not come from the workbook. `EnemyArchetypes.csv` and
