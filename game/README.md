...
| `Content/Data/` | Nineteen DataTable assets: seventeen imported from the design workbook, and two from the simulation package's enemy model. See below. |
...
Two of the nineteen do not come from the workbook. `EnemyArchetypes.csv` and
