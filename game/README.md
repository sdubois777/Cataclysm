...
| `Content/Data/` | Twenty-two DataTable assets: twenty imported from the design workbook, and two from the simulation package's enemy model. See below. |
...
Two of the twenty-two do not come from the workbook. `EnemyArchetypes.csv` and
