...
| `All_Things_Cataclysm.xlsx` | Sheet "All Things Cataclysm" | 27 sheets, listed below. Exported unchanged as `.xlsx`, and edited in place since. |
...
| Passive Effects | 323 | Node, Stat, Value Kind, Value Per Point, Required Tags, Condition, Condition Value, Scale, Scale Step, Option, Node Name, Reach Metres, Min Points |
| Weapon Meshes | 14 | Base Name, Mesh, Scale |
| Enchantment Effects | 373 | Enchantment, Effect, Stat, Value Kind, Value Low, Value High, Required Tags, Condition, Condition Value, Scale, Scale Step, Action, Action Event, Fraction Of, Scale Max Steps, Scale Offset, Stack Seconds, Every Seconds, Every Nth |
