...
| Passive Effects | 270 | Node, Stat, Value Kind, Value Per Point, Required Tags, Condition, Condition Value, Scale, Scale Step, Option, Node Name, Reach Metres |
| Weapon Meshes | 14 | Base Name, Mesh, Scale |
| Enchantment Effects | 169 | Enchantment, Effect, Stat, Value Kind, Value Low, Value High, Required Tags, Condition, Condition Value, Scale, Scale Step, Action, Action Event, Fraction Of |
