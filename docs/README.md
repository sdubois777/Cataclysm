...
| Passive Effects | 206 | Node, Stat, Value Kind, Value Per Point, Required Tags, Condition, Condition Value, Scale, Scale Step, Option, Node Name |
| Weapon Meshes | 14 | Base Name, Mesh, Scale |
| Enchantment Effects | 7 | Enchantment, Effect, Stat, Value Kind, Value Low, Value High, Required Tags, Condition, Condition Value, Scale, Scale Step |
